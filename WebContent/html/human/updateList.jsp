...
<body>
	...
	<s:url var="actionUrl" action="findUpdateList" namespace="/human" />
	...
	<table class="data_list_table">
		...
		<s:iterator value="humanList" var="human">
			<tr>
				...
				<s:property	value="#human.firstKindName" /></td>
				...
				<td class="list_data_op"><s:url var="docheckUrl" action="edit"
					...
					</s:url> <a href="<s:property value="#docheckUrl"/>&type=update">更新</a></td>
			</tr>
		</s:iterator>
