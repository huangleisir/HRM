...
<script type="text/javascript">
	jQuery(function($) {
		...
		$("#start").bind("click", function() {
			location.href='tblResumeAction!validSpliter.action?mjkid='+$("#mjkind").val();
		});
	...
	<table class="data_list_table">
		...
		<s:iterator value="list" status="stat" var="resume">
			<tr>
				...
				<td class="list_data_text">
					<a href="tblResumeAction!check.action?query=1&res.resId=<s:property value='#resume.resId'/>">面试</a>
				</td>
			</tr>
		</s:iterator>
		<tr>
