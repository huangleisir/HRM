...
<script type="text/javascript">
	jQuery(function($) {
		...
		$("#start").bind("click", function() {
			location.href='tblInterviewAction!registedSpliter.action?mjkid='+$("#mjkind").val();
		});
	...
	<table class="data_list_table">
		...
		<s:iterator value="list" status="stat" var="resume">
			<tr>
				...
				<td class="list_data_text">
					<a href="tblInterviewAction!check.action?queid=1&resume.resId=<s:property value='#resume.resId'/>">筛选</a>
				</td>
			</tr>
		</s:iterator>
		<tr>
