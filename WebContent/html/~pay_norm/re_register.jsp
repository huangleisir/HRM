...
<div class="page_title">薪酬标准管理  > 薪酬标准登记复核 </div>
<div class="button_bar">
	<button type="submit" class="common_button" id="btn" >登记复核通过</button> 
	...
	<!-- <button class="common_button" onclick="window.location='register.jsp';">返回</button>   -->
</div>
<table class="query_form_table">
	<tr>
		...
		<input type="text" id="standardId" name="tblStandardSalary.standardId" value="<s:property value="tblStandardSalary.standardId"/>" valType="OTHER" regString="^[0-9]{1,28}$" msg="<font color=red>*</font>1-28位数字"/>
		</td>
		<th>薪酬标准名称</th>
		<td>
	...
	<tr>
		...
		<input type="hidden" name="tblStandardSalary.registTime" value="<s:property value="tblStandardSalary.registTime"/>">
		<input type="hidden" name="tblStandardSalary.changeTime" value="<s:property value="tblStandardSalary.changeTime"/>">
		</td>
	</tr>
	
	<tr>
		<th>复核意见</th>
		<td colspan="5"><textarea rows="6" cols="50" name="tblStandardSalary.checkCommnet" valType="required" msg="<font color=red>*</font>不能为空"></textarea></td>
	</tr>
