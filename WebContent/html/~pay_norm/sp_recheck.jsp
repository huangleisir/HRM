...
<body>
<div class="page_title">薪酬标准管理  > 薪酬标准设置复核查询 </div>
...
<table class="data_list_table">
 ...
 <s:iterator value="list" status="stat" var="tblStandardSalary">
	...
	<td>
		...
		<td>
		<a href="tblStandardSalaryAction!sp_register.action?tblStandardSalary.ssdId=<s:property value='#tblStandardSalary.ssdId' />">复核</a>
		</td>	
