...
<body>
<div class="page_title">薪酬标准管理 > 薪酬标准查询 </div>

<form action="tblStandardSalaryAction!check.action" name="form1" method="post" >
...
<table class="data_list_table">
	...
	<tr>
		<th>请输入登录时间</th>
		<td><!-- <input  type="text" name="tblStandardSalary.standardName" />至<input  type="text"/>（YYYY-MM-DD）-->
		<!-- 日期标签 label="登入时间" -->
...
<table class="data_list_table">
 ...
 <s:iterator value="list" status="stat" var="tblStandardSalary">
	...
	<td>
		...
		<a onClick="checkit()" href="tblStandardSalaryAction!delete.action?tblStandardSalary.ssdId=<s:property value='#tblStandardSalary.ssdId' /> ">删除</a>
		</td> --%>	
