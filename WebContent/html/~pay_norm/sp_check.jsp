...
<body>
<div class="page_title">薪酬管理  > 薪酬设置查询 </div>

<form action="tblStandardSalaryAction!sp_check1.action" name="form1" method="post" >
...
<table class="data_list_table">
 ...
 <s:iterator value="list" status="stat" var="tblStandardSalary">
	...
	<td>
		...
		<td>
		<a href="tblStandardSalaryAction!sp_modify.action?tblStandardSalary.ssdId=<s:property value='#tblStandardSalary.ssdId' />">薪酬设置</a>
		</td>	
