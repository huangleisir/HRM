...
<form action="tblThirdClassAction!update.action" method="post" onsubmit="return checkm3all();">
...
<table class="query_form_table">
	<tr>
		...
		<td>
			<select name="tblThirdClass.firstKindId">
				<option><s:property value='tblThirdClass.firstKindId' /></option>
			</select>
		</td>
		<th>I级机构名称</th>
		<td>
			<input readonly="readonly" name="tblThirdClass.firstKindName" value="<s:property value='tblThirdClass.firstKindName' />" />
		</td>
	</tr>
	<tr>
		<th>II级机构编号</th>
		<td>
			<select name="tblThirdClass.secondKindId">
				<option><s:property value='tblThirdClass.secondKindId' /></option>
			</select>
		</td>
		<th>II级机构名称</th>
		<td>
			<input readonly="readonly" name="tblThirdClass.secondKindName" value="<s:property value='tblThirdClass.secondKindName' />" />
		</td>
	</tr>	
	<tr>
		<th>III级机构编号</th>
		<td><input name="tblThirdClass.ftkId" type="hidden" value="<s:property value='tblThirdClass.ftkId' />"/><input id="id" name="tblThirdClass.thirdKindId" value="<s:property value='tblThirdClass.thirdKindId' />" onblur="return checkm3id();"/><span id="tipid" class="red_star">*</span></td>
	</tr>
	<tr>
		<th>III级机构名称</th>
		<td><input id="name" name="tblThirdClass.thirdKindName" value="<s:property value='tblThirdClass.thirdKindName' />" onblur="return checkm3name();"/><span id="tipname" class="red_star">*</span></td>
	</tr>
	<tr>
		<th>是否是零售店</th>
		<td colspan="3">
	...
	<tr>
		...
		<td colspan="3"><textarea id="sale" name="tblThirdClass.thirdKindSaleId" rows="6" cols="50" onblur="return checkm3sale();"><s:property value='tblThirdClass.thirdKindSaleId' /></textarea><span id="tipsale" class="red_star">*</span></td>
	</tr>
	</table>
<br />
</form>
