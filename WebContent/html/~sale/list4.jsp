...
<div class="button_bar">
	...
	--><button class="common_button" onclick="to('html/~sale/edit4.jsp');">添加</button>  
	</div>
...
<table class="data_list_table">
	...
	<s:iterator value="list" status="stat" var="tblMajorName">
	<tr>
		<td class="list_data_number"><s:property value='#tblMajorName.majorName' /></td>
		<td class="list_data_op">
			...
			<img onclick="to('tblMajorNameAction!delete.action?tblMajorName.makId='+<s:property value='#tblMajorName.makId'/>);" title="删除" src="images/bt_del.gif" class="op_button" />
