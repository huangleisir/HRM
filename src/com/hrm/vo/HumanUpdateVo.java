...
public class HumanUpdateVo {
	private Integer hufId;//id
	private String humanMajorId;//职位id
	private String humanMajorName;//职位名称
	private String humanName;//姓名
	private Byte humanSex;//性别
	private String humanEmail;//邮箱
	private String humanTelephone;//电话
	private String humanQq;//qq
	...
	private String humanEducatedDegree;//学位
	private Integer humanEducatedYears;//专业年制
	private String humanEducatedMajor;//专业
	private String salaryStandardId;//标准薪水id
	private String salaryStandardName;//标准薪水名称
	private String humanBank;//银行
	private String humanAccount;//银行账号
	private String changer;//变更人
	private String changeTime;//修改时间
	private String humanHistroyRecords;//个人履历
	private String humanFamilyMembership;//家庭关系成员
	private String remark;//备注
	private String humanPicture;//图片
