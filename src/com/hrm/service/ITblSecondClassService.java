...
public interface ITblSecondClassService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblSecondClass> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblSecondClass> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblSecondClass> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblSecondClass> getScrollData(int firstindex, int maxresult);
