...
public interface ITblMajorNameService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblMajorName> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblMajorName> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblMajorName> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblMajorName> getScrollData(int firstindex, int maxresult);
