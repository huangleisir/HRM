...
public interface ITblPublicAttributeService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblPublicAttribute> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblPublicAttribute> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblPublicAttribute> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblPublicAttribute> getScrollData(int firstindex, int maxresult);
