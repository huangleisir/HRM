...
public interface ITblQuestionsService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblQuestions> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblQuestions> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblQuestions> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblQuestions> getScrollData(int firstindex, int maxresult);
