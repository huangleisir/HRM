...
public interface ITblFirstQuestionsService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblFirstQuestions> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblFirstQuestions> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblFirstQuestions> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblFirstQuestions> getScrollData(int firstindex, int maxresult);
