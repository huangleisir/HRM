...
public interface ITblResumeService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblResume> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblResume> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblResume> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblResume> getScrollData(int firstindex, int maxresult);
