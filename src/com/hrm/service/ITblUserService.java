...
public interface ITblUserService {
	 ...
	 * @return
	 */
	public QueryResult<TblUser> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblUser> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblUser> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
