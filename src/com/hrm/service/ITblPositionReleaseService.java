...
public interface ITblPositionReleaseService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblPositionRelease> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblPositionRelease> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblPositionRelease> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblPositionRelease> getScrollData(int firstindex, int maxresult);
