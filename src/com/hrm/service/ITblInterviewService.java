...
public interface ITblInterviewService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblInterview> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblInterview> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblInterview> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblInterview> getScrollData(int firstindex, int maxresult);
