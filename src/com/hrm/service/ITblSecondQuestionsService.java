...
public interface ITblSecondQuestionsService {
	/**
	 * 获取记录总数
	 ...
	 * @return
	 */
	public QueryResult<TblSecondQuestions> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams,LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblSecondQuestions> getScrollData(int firstindex, int maxresult, String whereHql, Object[] queryParams);
	
	public QueryResult<TblSecondQuestions> getScrollData(int firstindex, int maxresult, LinkedHashMap<String, String> orderby);
	
	public QueryResult<TblSecondQuestions> getScrollData(int firstindex, int maxresult);
